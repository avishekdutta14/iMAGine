...
4. [bwa](https://github.com/lh3/bwa) - not needed for imagine-g.sh
5. [samtools](https://github.com/samtools/samtools) - not needed for imagine-g.sh
6. [metabat2](https://bitbucket.org/berkeleylab/metabat/src/master/) - not needed for imagine-g.sh
7. [CheckM](https://github.com/Ecogenomics/CheckM)
8. [GTDB-TK](https://github.com/Ecogenomics/GTDBTk) - not needed for imagine.sh
...
1. iMAGine - Dutta, A., Connors, E., Trinh, R., Erazo, N., Dasarathy, S., Ducklow, H. W., ... & Bowman, J. S. (2023). Depth drives the distribution of microbial ecological functions in the coastal western Antarctic Peninsula. Frontiers in Microbiology, 14, 1494. https://doi.org/10.3389/fmicb.2023.1168507
2. fastp - Shifu Chen, Yanqing Zhou, Yaru Chen, Jia Gu, fastp: an ultra-fast all-in-one FASTQ preprocessor, Bioinformatics, Volume 34, Issue 17, 01 September 2018, Pages i884–i890, https://doi.org/10.1093/bioinformatics/bty560
3. MetaSPAdes - Nurk S, Meleshko D, Korobeynikov A, Pevzner PA. metaSPAdes: a new versatile metagenomic assembler. Genome Res. 2017;27(5):824-834. doi:10.1101/gr.213959.116
4. QUAST- Alexey Gurevich, Vladislav Saveliev, Nikolay Vyahhi, Glenn Tesler, QUAST: quality assessment tool for genome assemblies, Bioinformatics, Volume 29, Issue 8, 15 April 2013, Pages 1072–1075, https://doi.org/10.1093/bioinformatics/btt086
5. bwa- Heng Li, Richard Durbin, Fast and accurate short read alignment with Burrows–Wheeler transform, Bioinformatics, Volume 25, Issue 14, 15 July 2009, Pages 1754–1760, https://doi.org/10.1093/bioinformatics/btp324
6. samtools- Li H, Handsaker B, Wysoker A, et al. The Sequence Alignment/Map format and SAMtools. Bioinformatics. 2009;25(16):2078-2079. doi:10.1093/bioinformatics/btp352
7. metabat2- Kang DD, Li F, Kirton E, et al. MetaBAT 2: an adaptive binning algorithm for robust and efficient genome reconstruction from metagenome assemblies. PeerJ. 2019;7:e7359. Published 2019 Jul 26. doi:10.7717/peerj.7359
8. checkM- Parks DH, Imelfort M, Skennerton CT, Hugenholtz P, Tyson GW. CheckM: assessing the quality of microbial genomes recovered from isolates, single cells, and metagenomes. Genome Res. 2015;25(7):1043-1055. doi:10.1101/gr.186072.114
